...
set("rr", "<cmd>restart<cr>", "Restart Neovim")
set("rs", "<cmd>mksession! /tmp/Session.vim | restart | source /tmp/Session.vim<cr>", "Restart Neovim, restoring session")
...
end, "Dismiss notifications", true)
